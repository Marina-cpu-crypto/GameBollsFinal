...
namespace GameBolls3._0
{
    class FieldsState
    {
        ...
        public void InitializeField(string[,] gameField, string level) // Инициализация пустого поля
        {
            for (int i = 4; i > 0; i--)
            {
            ...
            if (level == "1")
            {
                InitializeLevel1(gameField);
            }
            else if (level == "2")
            {
                InitializeLevel2(gameField);
            }
            else
            {
                InitializeLevel3(gameField);
            }
        }

        private void InitializeLevel1(string[,] gameField)
        {
            ...
            for (int i = 4; i > 1; i--)
            {
                ...
                {
                    ProcessCell(gameField, i, j, list);
                }
            }
        ...
        private void InitializeLevel2(string[,] gameField)
        {
        ...
        private void InitializeLevel3(string[,] gameField)
        {
        ...
        private void ProcessCell(string[,] gameField, int i, int j, List<string> list)
        {
